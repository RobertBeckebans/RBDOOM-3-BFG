...
// SRS - optionally needed for VK_MVK_MOLTENVK_EXTENSION_NAME visibility
...
bool VKimp_Init( glimpParms_t parms )
{
	...
	for( int i = 0; i < 16; i++ )
	{
		...
		// RB begin
        // SRS - GetDisplayFrequency() gets the actual refresh rate for windowed and fullscreen modes
